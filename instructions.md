...
- Under 80 words for answers unless the situation warrants more words
...
1. **Context Engineering**: Enable app to surface the right information at right time
2. **Multi-LLM Orchestration**: Balance performance and cost by orchestrating and utilizing multiple LLMs at what they are good at
3. **Tool Calls**: Extend capabilities pragmatically by calling tools beyond what the LLM can do
4. **Human-in-Loop GUI**: Create app-specific interfaces for human oversight in the app 
5. **Autonomy Slider**: Let users control AI independence level through a slider (default 50%)
